...
{
    //LOG("Java_com_demo_TargetDemo_TargetDemo_GLRenderer_renderFrame");
    ...
    for(int tIdx = 0; tIdx < state.getNumActiveTrackables(); tIdx++)
    {
        ...
        int textureIndex = (!strcmp(trackable->getName(), "saber")) ? 0 : 1;
        const Texture* const thisTexture = textures[textureIndex];

		displayMessage("Picture detected");
/*
#ifdef USE_OPENGL_ES_1_1
...
{
    //LOG("Java_com_demo_TargetDemo_TargetDemo_initApplicationNative");
...
JNIEXPORT void JNICALL
Java_com_demo_TargetDemo_TargetDemo_startCamera(JNIEnv *,
                                                                         jobject)
{
    //LOG("Java_com_demo_TargetDemo_TargetDemo_startCamera");
